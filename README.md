...
| 短序列测评<br>（序列长度200-600bp) | 评价模型对基因元件的识别和理解能力，如预测序列是否是外显子、启动子、增强子、甲基化等基因元件 | demo coding vs intergenomic seqs\[3\] | **0.9914** | 0.9708 | **0.9886** | 0.9824 | 0.9814 | 0.9855 | 0.9127 | 0.9763 |
...
| 人群预测（序列长度） | 评价模型是否能有效利用更长序列中包含的更多的基因信息进行更为准确的推断 | Human classify 8192 | **0.6667** | **0.6349** | 0.6309 | / | / | 0.6138 | 0.6239 | / |
